...
/// Copied from https://github.com/david-legend/otp_textfield and Has licence : https://github.com/david-legend/otp_textfield/blob/master/LICENSE
/// Modified to be a label and not a input text field
...
class PlaceValuesAwareNumbersLabel extends StatefulWidget {
  ...
  @override
  _PlaceValuesAwareNumbersLabelState createState() => _PlaceValuesAwareNumbersLabelState();
}

class _PlaceValuesAwareNumbersLabelState extends State<PlaceValuesAwareNumbersLabel> {
  ...
  @override
  void didUpdateWidget(covariant PlaceValuesAwareNumbersLabel oldWidget) {
